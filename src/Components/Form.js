        ...
        <div className="">
            ...
            <form action="" className="px-4 max-w-2xl w-3/4 mx-auto flex flex-col justify-center items-center bg-white shadow mt-4 py-8 rounded text-secondary">
              <div className="flex justify-center items-center flex-col sm:flex-row">
                <p className="text-center">Csapat kiválasztása<span className="text-red-600">*</span></p>
                <select className="mx-4 px-2 w-full border border-formBorder sm:w-auto focus:outline-none focus:ring-2 focus:ring-estiemGreen focus:border-opacity-0">
